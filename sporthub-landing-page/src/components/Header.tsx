    ...
    return (
        <header className="text-white z-10 h-20 2xl:h-24 absolute top-0 left-0 w-full bg-main-blue">
            <nav className="flex items-center justify-between px-6 md:px-10 2xl:px-16 h-full">
                ...
                <a href="#" className="hidden md:flex items-center gap-2 bg-secondary-blue text-white text-sm 2xl:text-base px-5 2xl:px-6 py-2.5 2xl:py-3 rounded-full hover:brightness-110 transition-all">
            ...
            {menuOpen && (
                <div className="md:hidden bg-main-blue flex flex-col items-center gap-6 py-8 text-sm font-medium">
                    ...
                    <a href="#" className="flex items-center gap-2 bg-secondary-blue px-5 py-2.5 rounded-full">
