...
export function ContactSection() {
    return (
        <section className="bg-main-blue text-white min-h-screen flex flex-col items-center px-6 pt-16 pb-0">

            <span className="text-secondary-blue text-xs tracking-widest uppercase font-semibold mb-2">
                Fale conosco
            </span>
            <h2 className="text-5xl font-bold tracking-widest uppercase mb-3">Contato</h2>
            <p className="text-lg mb-2">Vamos marcar sua primeira visita?</p>
            ...
            <div className="mt-8 w-full max-w-xl bg-[#132060] border border-secondary-blue/25 rounded-2xl p-10 shadow-2xl">
                ...
                <button className="bg-secondary-blue text-white px-7 py-3 rounded-xl text-sm font-medium hover:bg-blue-700 transition-all hover:-translate-y-0.5 active:translate-y-0">
                    Enviar mensagem
                </button>
            </div>


            <div className="mt-12 w-full max-w-xl grid grid-cols-2 gap-8 pb-12">
                <div>
                    <h4 className="text-lg font-semibold tracking-widest uppercase mb-4">Contatos</h4>
                    <div className="flex flex-col gap-3">
                        <p className="flex items-center gap-2 text-sm text-white/55">
                            <FaPhone size={13} /> (31) 2580-1921
                        </p>
                        <p className="flex items-center gap-2 text-sm text-white/55">
                            <FaEnvelope size={13} /> email@exemplo.com.br
                        </p>
                        <p className="flex items-center gap-2 text-sm text-white/55">
                            <FaMobileAlt size={13} /> (31) 9XXXX-XXXX
                        </p>
                        <p className="flex items-center gap-2 text-sm text-white/55">
                            <FaMapMarkerAlt size={13} /> Pampulha — Belo Horizonte / MG
                        </p>
                    </div>
                </div>
                <div>
