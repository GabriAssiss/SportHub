...
const slides = [
    ...
    { image: carousel2, title: "Futevôlei", phrase: "Muito mais que um jogo, é o ritmo da praia em quadra." },
    { image: carousel3, title: "Pickleball", phrase: "Dinâmico, estratégico e impossível de jogar uma vez só." },
    { image: carousel4, title: "Beach Tennis", phrase: "Trocas rápidas, sorrisos garantidos e a areia sob os pés." },
    { image: carousel5, title: "Tênis", phrase: "Foco total na linha, precisão em cada golpe." },
    { image: carousel6, title: "Academia", phrase: "Sua melhor versão é construída um treino por dia." },
];
